...
export const zones = [
  { id: 'Antananarivo', label: 'Antananarivo', value: 'Antananarivo' },
  { id: 'Antsirabe', label: 'Antsirabe', value: 'Antsirabe' },
  { id: 'Mahajanga', label: 'Mahajanga', value: 'Mahajanga' },
  { id: 'Toamasina', label: 'Toamasina', value: 'Toamasina' },
  { id: 'Fianarantsoa', label: 'Fianarantsoa', value: 'Fianarantsoa' },
  { id: 'Toliara', label: 'Toliara', value: 'Toliara' },
  { id: 'Nosy Be', label: 'Nosy Be', value: 'Nosy Be' },
  { id: 'Antsiranana', label: 'Antsiranana', value: 'Antsiranana' },
  { id: 'Morondava', label: 'Morondava', value: 'Morondava' },
  { id: 'Fort Dauphin', label: 'Fort Dauphin', value: 'Fort Dauphin' },
  ...
  { id: 'Vohémar', label: 'Vohémar', value: 'Vohémar' },
  { id: 'Moramanga', label: 'Moramanga', value: 'Moramanga' },
  { id: 'Tamatave', label: 'Tamatave', value: 'Tamatave' },
  { id: 'Ambositra', label: 'Ambositra', value: 'Ambositra' },
  { id: 'Mandoto', label: 'Mandoto', value: 'Mandoto' },
]
