...
export const DeliveryCompanyCard: React.FC<DeliveryCompanyCardProps> = ({ company }) => {
  ...
  return (
    <div className="bg-white dark:bg-dark-surface rounded-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 hover:border-primary/50 transition-all duration-300 group">
      {/* Header */}
      <div className="bg-gradient-to-r from-neutral-50 to-white dark:from-neutral-900 dark:to-dark-surface px-6 py-5 border-b border-neutral-200 dark:border-neutral-800">
        {company.verified && (
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="space-y-1.5">
            ...
            <div className="font-semibold text-neutral-900 dark:text-white text-lg font-sans">{company.deliveryTime}</div>
            <div className="text-xs text-neutral-500 dark:text-neutral-400 font-sans">{company.workingHours}</div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="font-semibold text-neutral-900 dark:text-white text-lg font-sans">{company.areas.length} {company.areas.length > 1 ? 'zones' : 'zone'}</div>
            <div className="text-xs text-neutral-500 dark:text-neutral-400 font-sans">{company.deliveryFee || "Tarif variable"}</div>
          </div>
        </div>
